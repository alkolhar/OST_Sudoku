...
/**
 * @author mustafa 
 * Diese lösung war in Ordnung und getestet, aber langsam und wurde daher entfernt
 */
public class AltModelGrid {
	...
	public void newGame() {
		...
		/*
		 * auch diese alternative Lösung funktioniert nicht gut und wurde getestet, ist
		 * aber langsamer und wurde daher auch entfernt Das Speichern des Grid in mehr
		 * als einem Array kann in Zukunft auf viele Probleme stoßen, daher wurde dies
		 * ausgeschlossen 
		 **/
